...
namespace Foo\Bar\Waldo {
	...
	use Foo\Bar\NamespacedAttribute;

	class ClassWithImportedAttribute
	{

		#[NamespacedAttribute]
		public function allowedMethod(\PhpOption\None $param): void
		{
		}


		public function forbiddenMethod(\PhpOption\None $param): void
		{
		}
