...
/**
 * @extends RuleTestCase<GotoControlStructure>
 */
class GotoControlStructureTest extends RuleTestCase
{
	...
	protected function getRule(): Rule
	{
		...
		return new GotoControlStructure(
	...
	public function testRule(): void
	{
		...
		$this->analyse([__DIR__ . '/../src/disallowed/controlStructures.php'], [
			[
				...
				'Using the goto control structure is forbidden.',
				// on this line:
				116,
			],
		]);
