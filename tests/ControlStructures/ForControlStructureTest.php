...
/**
 * @extends RuleTestCase<ForControlStructure>
 */
class ForControlStructureTest extends RuleTestCase
{
	...
	protected function getRule(): Rule
	{
		...
		return new ForControlStructure(
	...
	public function testRule(): void
	{
		...
		$this->analyse([__DIR__ . '/../src/disallowed/controlStructures.php'], [
			[
				...
				'Using the for control structure is forbidden.',
				// on this line:
				56,
			],
			[
