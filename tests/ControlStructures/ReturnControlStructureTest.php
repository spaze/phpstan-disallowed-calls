...
/**
 * @extends RuleTestCase<ReturnControlStructure>
 */
class ReturnControlStructureTest extends RuleTestCase
{
	...
	protected function getRule(): Rule
	{
		...
		return new ReturnControlStructure(
	...
	public function testRule(): void
	{
		...
		$this->analyse([__DIR__ . '/../src/disallowed/controlStructures.php'], [
			[
				...
				'Using the return control structure is forbidden.',
				// on this line:
				13,
			],
		]);
